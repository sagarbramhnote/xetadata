...
@Component({
  selector: 'app-telephone-profile',
  templateUrl: './telephone-profile.component.html',
  styleUrls: ['./telephone-profile.component.css']
})
export class TelephoneProfileComponent {
