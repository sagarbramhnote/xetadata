...
@Component({
  selector: 'app-postal-address-profile',
  templateUrl: './postal-address-profile.component.html',
  styleUrls: ['./postal-address-profile.component.css']
})
export class PostalAddressProfileComponent {
  @Input() endpoint:any
