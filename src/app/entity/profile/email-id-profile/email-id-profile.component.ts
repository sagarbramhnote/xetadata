...
@Component({
  selector: 'app-email-id-profile',
  templateUrl: './email-id-profile.component.html',
  styleUrls: ['./email-id-profile.component.css']
})
export class EmailIDProfileComponent implements OnInit{
