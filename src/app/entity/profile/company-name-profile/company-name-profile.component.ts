...
@Component({
  selector: 'app-company-name-profile',
  templateUrl: './company-name-profile.component.html',
  styleUrls: ['./company-name-profile.component.css']
})
export class CompanyNameProfileComponent implements OnInit{
