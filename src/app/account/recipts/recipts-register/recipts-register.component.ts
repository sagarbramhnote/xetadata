...
@Component({
  selector: 'app-recipts-register',
  templateUrl: './recipts-register.component.html',
  styleUrls: ['./recipts-register.component.scss'],
  providers: [ConfirmationService,MessageService]
})
export class ReciptsRegisterComponent {
