...
@Component({
  selector: 'app-sales-invoice-ageing',
  templateUrl: './sales-invoice-ageing.component.html',
  styleUrls: ['./sales-invoice-ageing.component.scss'],
  providers: [ConfirmationService,MessageService]
})
export class SalesInvoiceAgeingComponent {
