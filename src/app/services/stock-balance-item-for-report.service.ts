...
export class StockBalanceItemForReportService {

  constructor(private http:HttpClient) { }

  fetchStockBalance(criteria:any) {
    ...
    let ROOT_URL = 'https://'+loginObject.appurl+'/unifund/AuthStockBalanceItemForReport';
