...
export class PartyAccountBalanceListService {

  constructor(private http:HttpClient) { }

  fetchPartyBalanceList(criteria:any) {
    ...
    let ROOT_URL = 'https://'+loginObject.appurl+'/unifund/AuthPartyAccountBalanceList';
