...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'contacts', data: { breadcrumb: 'Contacts' }, loadChildren: () => import('./contacts/contacts.module').then(m => m.ContactsModule), canActivate:[authenticationGuard()]},
            ...
            { path: 'report',data: { breadcrumb: 'Report' }, loadChildren: () => import('./reports/report.module').then(m => m.ReportModule), canActivate:[authenticationGuard()]},
